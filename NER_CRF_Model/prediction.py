...
import argparse
from Sumerian_NER_CRF_features import features
...
if __name__=='__main__':
    ...
    parser.add_argument("-s","--saved",help="Location of saved CRF weights in .pkl format", default="Saved_Models/NER_CRF_Model.pkl" )
    parser.add_argument("-o","--output",help="Location of output text file(Result)", default='Output/NER_tagged_sentences_crf.txt')
