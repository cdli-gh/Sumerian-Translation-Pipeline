...
if __name__=='__main__':
    ...
    parser.add_argument("-s","--saved",help="Location of saved CRF weights in .h5 format", default="Saved_Models/POS/POS_Bi_LSTM.h5" )
    parser.add_argument("-o","--output",help="Location of output text file(Result)", default='Output/Pos_Bi_LSTM.txt')
