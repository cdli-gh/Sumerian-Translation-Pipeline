...
def evaluate_model(history):    
    ...
    plt.plot(history.history['val_crf_viterbi_accuracy'], label='Validation')
    plt.legend()
    plt.show();
...
if __name__=='__main__':
    ...
    #saved_path='Saved_Models/POS_Bi_LSTM_CRF.h5'
    ...
    parser.add_argument("-o","--output",help="Location of model weights to be saved",default="Saved_Models/POS/POS_Bi_LSTM_CRF.h5")
