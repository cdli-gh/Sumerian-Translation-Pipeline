...
if __name__=='__main__':
    ...
    parser.add_argument("-s","--saved",help="Location of saved CRF weights in .pkl format", default="Saved_Models/POS/POS_CRF.pkl" )
    parser.add_argument("-o","--output",help="Location of output text file(Result)", default='Output/POS_CRF.txt')
