...
cdli_catalogue_csv = csv.DictReader(open("Data/cdli_catalogue.csv", "r"))
cdli_catalogue = []
...
def list_of_genres():
    cdli_catalogue_csv = open("Data/cdli_catalogue.csv", "r")
...
def translated_sumerian ():
    sumerian_translated = open("sumerian_translated.txt","w")
...
def all_sumerian():
    sumerian_untranslated = open("sumerian_untranslated.txt","w")
