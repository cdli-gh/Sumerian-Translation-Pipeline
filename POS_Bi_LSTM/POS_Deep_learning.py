...
if __name__=='__main__':
    ...
    parser.add_argument("-e","--embedding",help="Location of sumerian word embeddings",default='Word_Embeddings/sumerian_fasttext_100.txt')
    parser.add_argument("-o","--output",help="Location of model weights to be saved",default="Saved_Models/model.h5")
