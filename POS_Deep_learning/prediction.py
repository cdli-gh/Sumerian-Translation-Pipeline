...
def preparetestData(sentences,word2idx,MAX):
    X=[]
    for s in sentences:
        l=[]
        s=s.split()
...
if __name__=='__main__':
    ...
    parser.add_argument("-s","--saved",help="Location of saved CRF weights in .h5 format", default="Saved_Models/model.h5" )
    parser.add_argument("-o","--output",help="Location of output text file(Result)", default='Output/Pos_tagged_sentences_Deep_learning.txt')
